 ...
 */
@UnstableApi
public class RockRendersFactory implements RenderersFactory {
    ...
    public boolean useHardwareVideoCodec = false;

    public void setUseHardwareVideoCodec(Boolean b) {
        useHardwareVideoCodec = b;
    }
    ...
    private static final String TAG = "RockRendersFactory";
     ...
     */
    public RockRendersFactory(Context context) {
        this.context = context;
        codecAdapterFactory = new DefaultMediaCodecAdapterFactory(context);
        extensionRendererMode = EXTENSION_RENDERER_MODE_PREFER;
    ...
    public final RockRendersFactory setExtensionRendererMode(@DefaultRenderersFactory.ExtensionRendererMode int extensionRendererMode) {
    ...
    public final DefaultRenderersFactory forceEnableMediaCodecAsynchronousQueueing() {
        ...
        return this.forceEnableMediaCodecAsynchronousQueueing();
    }
    ...
    public final RockRendersFactory forceDisableMediaCodecAsynchronousQueueing() {
    ...
    public final RockRendersFactory experimentalSetMediaCodecAsyncCryptoFlagEnabled(boolean enableAsyncCryptoFlag) {
    ...
    public final RockRendersFactory setEnableDecoderFallback(boolean enableDecoderFallback) {
    ...
    public final RockRendersFactory setMediaCodecSelector(MediaCodecSelector mediaCodecSelector) {
    ...
    public final RockRendersFactory setEnableAudioFloatOutput(boolean enableFloatOutput) {
    ...
    public final RockRendersFactory setEnableAudioTrackPlaybackParams(boolean enableAudioTrackPlaybackParams) {
    ...
    public final RockRendersFactory setAllowedVideoJoiningTimeMs(long allowedVideoJoiningTimeMs) {
    ...
    public Renderer[] createRenderers(Handler eventHandler, VideoRendererEventListener videoRendererEventListener, AudioRendererEventListener audioRendererEventListener, TextOutput textRendererOutput, MetadataOutput metadataRendererOutput) {
        ...
        @Nullable AudioSink audioSink = buildAudioSink(context, enableFloatOutput, enableAudioTrackPlaybackParams);
        if (audioSink != null) {
    ...
    protected void buildVideoRenderers(Context context, int extensionRendererMode, MediaCodecSelector mediaCodecSelector, boolean enableDecoderFallback, Handler eventHandler, VideoRendererEventListener eventListener, long allowedVideoJoiningTimeMs, ArrayList<Renderer> out) {
        ...
        if (extensionRendererMode == EXTENSION_RENDERER_MODE_OFF || useHardwareVideoCodec) {
            Log.i(TAG, "Using hardware video decoder.");
            return;
        }
        ...
        try {
            ...
            Constructor<?> constructor = clazz.getConstructor(long.class, Handler.class, VideoRendererEventListener.class, int.class);
    ...
    protected void buildAudioRenderers(Context context, int extensionRendererMode, MediaCodecSelector mediaCodecSelector, boolean enableDecoderFallback, AudioSink audioSink, Handler eventHandler, AudioRendererEventListener eventListener, ArrayList<Renderer> out) {
        ...
        try {
            ...
            Constructor<?> constructor = clazz.getConstructor(Handler.class, AudioRendererEventListener.class, AudioSink.class);
            Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener, audioSink);
            out.add(extensionRendererIndex++, renderer);
            Log.e(TAG, "Loaded FfmpegAudioRenderer.");
        } catch (ClassNotFoundException e) {
            // Expected if the app was built without the extension.
            Log.e(TAG, "Not Found FfmpegAudioRenderer.");
        } catch (Exception e) {
            // The extension is present, but instantiation failed.
            throw new RuntimeException("Error instantiating FFmpeg extension", e);
        }
